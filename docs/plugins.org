...
:CUSTOM_ID: org-crypt
:END:
Link: [[https://github.com/taybin/org-crypt.nvim][org-crypt.nvim]]

This is the port of Emacs [[https://orgmode.org/manual/Org-Crypt.html][org-crypt]].
